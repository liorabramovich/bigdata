...
async function getRandomRADECFromJSON() {
  ...
  (async () => {
    ...
    //   console.log(theJSON);
      ...
      // Example usage:
      randomEventJSON = getRandomEventJSON();
      // Function to send JSON data to all connected clients
        function sendRandomDataToClients() {
            const jsonData = getRandomEventJSON();
        ...
        // Simulate sending random data to clients every 3 seconds
        setInterval(() => {
            sendRandomDataToClients();
        }, 3000);
        ...
        wss.on('connection', (socket) => {
            ...
            // Simulate sending random data to the newly connected client immediately
            sendRandomDataToClients();
...
//   const jsonData = { key: 'value', random: randomNumber };
//   return jsonData;
// }
